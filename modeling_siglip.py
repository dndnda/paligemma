...
class SiglipVisionEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values: torch.FloatTensor) -> torch.Tensor:
        ...
        patch_embds = self.patch_embedding(pixel_values) # [Batch_size, Embed_dim, Num_patch_h, Num_patch_w]
        embeddings = patch_embds.flatten(2)
        embeddings = embeddings.transpose(1, 2) # [Batch_size, Num_patches, Embd_dim]
        embeddings = embeddings + self.position_embedding(self.position_ids) # positional: [1, Num_patches, Embd_dim]
        return embeddings
